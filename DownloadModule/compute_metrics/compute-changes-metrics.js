...
async function getReviewersMetrics(json, reviewersDocs) {
    ...
    return Promise.all([
        ...
        let metadata = {
            ...
            reviewersPriorMergedChangesSum: results[1].length > 0 ? results[1].sum : 0,
            reviewersPriorMergedChangesAvg: results[1].length > 0 ? results[1].avg : 0,
            reviewersPriorMergedChangesMax: results[1].length > 0 ? results[1].max : 0,
            reviewersPriorMergedChangesMin: results[1].length > 0 ? results[1].min : 0,
            reviewersPriorMergedChangesStd: results[1].length > 0 ? results[1].std : 0,

            reviewersPriorAbandonedChangesSum: results[2].length > 0 ? results[2].sum : 0,
            reviewersPriorAbandonedChangesAvg: results[2].length > 0 ? results[2].avg : 0,
            reviewersPriorAbandonedChangesMax: results[2].length > 0 ? results[2].max : 0,
            reviewersPriorAbandonedChangesMin: results[2].length > 0 ? results[2].min : 0,
            reviewersPriorAbandonedChangesStd: results[2].length > 0 ? results[2].std : 0,

            reviewersPriorUnCloseChangesSum: results[3].length > 0 ? results[3].sum : 0,
            reviewersPriorUnCloseChangesAvg: results[3].length > 0 ? results[3].avg : 0,
            reviewersPriorUnCloseChangesMax: results[3].length > 0 ? results[3].max : 0,
            reviewersPriorUnCloseChangesMin: results[3].length > 0 ? results[3].min : 0,
            reviewersPriorUnCloseChangesStd: results[3].length > 0 ? results[3].std : 0,

            reviewersNumberOfReviewSum: results[4].length > 0 ? results[4].sum : 0,
            reviewersNumberOfReviewAvg: results[4].length > 0 ? results[4].avg : 0,
            reviewersNumberOfReviewMax: results[4].length > 0 ? results[4].max : 0,
            reviewersNumberOfReviewMin: results[4].length > 0 ? results[4].min : 0,
            reviewersNumberOfReviewStd: results[4].length > 0 ? results[4].std : 0,

            reviewersPreviousMessageSum: results[5].length > 0 ? results[5].sum : 0,
            reviewersPreviousMessageAvg: results[5].length > 0 ? results[5].avg : 0,
            reviewersPreviousMessageMax: results[5].length > 0 ? results[5].max : 0,
            reviewersPreviousMessageMin: results[5].length > 0 ? results[5].min : 0,
            reviewersPreviousMessageStd: results[5].length > 0 ? results[5].std : 0,

            fileCountForReviewersCountAvg: results[6].length > 0 ? results[6].count_avg : 0,
            fileCountForReviewersCountMax: results[6].length > 0 ? results[6].count_max : 0,
            fileCountForReviewersCountMin: results[6].length > 0 ? results[6].count_min : 0,
            fileCountForReviewersCountStd: results[6].length > 0 ? results[6].count_std : 0,
            fileTimeForReviewersCountAvg: results[6].length > 0 ? results[6].time_avg : 0,
            fileTimeForReviewersCountMax: results[6].length > 0 ? results[6].time_max : 0,
            fileTimeForReviewersCountMin: results[6].length > 0 ? results[6].time_min : 0,
            fileTimeForReviewersCountStd: results[6].length > 0 ? results[6].time_std : 0,

            ownerAndReviewerCommonsChangesSum: results[7].length > 0 ? results[7].changes_sum : 0,
            ownerAndReviewerCommonsMessagesSum: results[7].length > 0 ? results[7].messages_sum : 0,

            ownerAndReviewerCommonsMessagesSumForRev: results[8].length > 0 ? results[8].sum : 0,
            ownerAndReviewerCommonsMessagesAvg: results[8].length > 0 ? results[8].avg : 0,
            ownerAndReviewerCommonsMessagesMax: results[8].length > 0 ? results[8].max : 0,
            ownerAndReviewerCommonsMessagesMin: results[8].length > 0 ? results[8].min : 0,
            ownerAndReviewerCommonsMessagesStd: results[8].length > 0 ? results[8].std : 0,

            reviewersChangesSum: results[9].length > 0 ? results[9].sum : 0,
            reviewersChangesAvg: results[9].length > 0 ? results[9].avg : 0,
            reviewersChangesMax: results[9].length > 0 ? results[9].max : 0,
            reviewersChangesMin: results[9].length > 0 ? results[9].min : 0,
            reviewersChangesStd: results[9].length > 0 ? results[9].std : 0,
