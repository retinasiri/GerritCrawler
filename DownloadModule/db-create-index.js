...
db.getCollection('metrics').createIndex({created_date: 1, number: 1})
...
db.getCollection('changes').createIndex({_number: -1, created: -1})
db.getCollection('changes').createIndex({_number: -1, created: 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, 'owner._account_id': 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, 'owner._account_id': 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, project: 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, project: 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, project: 1, 'owner._account_id': 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, project: 1, 'owner._account_id': 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, files_list: 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, files_list: 1, 'owner._account_id': 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, 'reviewers.REVIEWER._account_id': 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, "messages_per_account_before_close.account": 1})
db.getCollection('changes').createIndex({"messages_per_account_before_close.account": 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, branch: 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, branch: 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, branch: 1, 'owner._account_id': 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, updated: -1, status: 1, branch: 1, 'owner._account_id': 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, project: 1})
db.getCollection('changes').createIndex({_number: -1, created: -1, branch: 1})
